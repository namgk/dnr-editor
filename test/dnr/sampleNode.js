...
module.exports = function(RED) {
    ...
    RED.nodes.registerType( "rpi-gpio in 2" ,GPIOInNode);
    RED.nodes.registerType ( " rpi-gpio in 3" , GPIOInNode);
    RED.nodes.registerType  ( ' rpi-gpio in 4' , GPIOInNode);
    RED.nodes.registerType  (  " rpi-gpio in 5"  , GPIOInNode);
    RED.nodes.registerType  (  " rpi-gpio in 6"  , GPIOInNode);
    RED.nodes.registerType  (  
        " rpi-gpio in 7"  , GPIOInNode);
    RED.nodes.registerType  (  
        " rpi-gpio in 8"  
        , GPIOInNode);
    RED.nodes.registerType  (  
